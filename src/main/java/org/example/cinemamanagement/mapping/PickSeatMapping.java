...
public class PickSeatMapping {
    public static PickSeatDTO toDTO(PickSeat pickSeat) {
        ...
        pickSeatDTO.getPerformDTO().setFilmDTO(FilmMapping.toDTO(pickSeat.getPerform().getFilm()));
        pickSeatDTO.getPerformDTO().setCinemaRoomDTO(CinemaRoomMapping.toDTO(pickSeat.getPerform().getCinemaRoom()));
